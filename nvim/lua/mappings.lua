...
map(
    ...
    { desc = "Find and Replace current word curent file" }
)
map(
    "n",
    "<leader>rr",
    ":.,$s/\\<<C-r><C-w>\\>/<C-r><C-w>/gc<Left><Left><Left>",
    { desc = "Find and Replace current word from current position to the end" }
)
map(
    "n",
    "<leader>rf",
    ":.,$s///gc<Left><Left><Left><Left>",
    { desc = "Find and Replace commande from current position to the end" }
)
...
map(
    "v",
    "<leader>rr",
    [["zy:.,$s/<C-r>z//gc<Left><Left><Left>]],
    { desc = "Find and Replace selection from current position to the end" }
)
